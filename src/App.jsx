...
export default function App() {
  ...
  const products = [
    { id: 1, name: "iPhone 14", price: 799, category: "Phone", features: ["A15", "128GB", "Dual Camera"] },
    { id: 2, name: "Samsung Galaxy S21", price: 499, category: "Phone", features: ["AMOLED", "5G", "128GB"] },
    { id: 3, name: "Redmi Note 12", price: 249, category: "Phone", features: ["108MP Camera", "5000mAh"] },
    { id: 4, name: "OnePlus Nord CE", price: 329, category: "Phone", features: ["OxygenOS", "65W Charging"] },
    { id: 5, name: "Realme C55", price: 199, category: "Phone", features: ["5000mAh", "128GB"] },
  ];
...
- Samsung Galaxy S21
    ...
    try {
      ...
      // Extract product names AI recommended
      const recommendedNames = aiText
        .split("\n")
        .map((line) => line.replace("-", "").trim())
        .filter(Boolean);
    ...
    <div className="min-h-screen bg-gray-900 text-white p-6">
      ...
      <div className="max-w-2xl mx-auto bg-gray-800 p-6 rounded-xl shadow-lg">
        ...
        <button
          onClick={handleAskAI}
          disabled={loading}
          className="mt-4 w-full bg-blue-600 hover:bg-blue-700 p-3 rounded-lg text-lg font-semibold disabled:bg-gray-600"
        >
